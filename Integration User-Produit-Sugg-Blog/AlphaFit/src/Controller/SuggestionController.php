...
class SuggestionController extends AbstractController
{
     ...
     */
    public function index(SuggestionsRepository $SuggestionsRepository, ProduitRepository $ProduitRepository,Request $request): Response
    {
     ...
     */
    public function indexMy(SuggestionsRepository $SuggestionsRepository, ProduitRepository $ProduitRepository,Request $request): Response
    {   $user = 56;
     ...
     */
    public function indexb(ReclamationRepository $ReclamationRepository ,SuggestionsRepository $SuggestionsRepository, ProduitRepository $ProduitRepository): Response
    {
    ...
    public function new(Request $request,MailerInterface $mailer): Response
    {
        ...
        $user = $this->getUser();
        $Suggestions->setParticipantId(56);
