...
class StockController extends AbstractController
{
    ...
    /**
     * @Route("/listp", name="stock_listp", methods={"GET"})
     */
    public function listp(): Response
    {
        ...
        $html = $this->renderView('stock/listproduits.html.twig', [
            'stocks' => $stocks,
        ]);
    ...
    /**
     * @Route("/{id}", name="stock_delete", methods={"GET","POST"})
     */
    ...
    public function insertIfNotExists(Stock $stock)
    {
        // Check if it exists first
        $q = self::create("s")
            ->where("s.idproduit = ?", $stock->getIdproduit())
            ->execute();
